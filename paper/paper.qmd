...
ggplot(cleaned_data, aes(x = end_date, y = pct)) +
  geom_point(alpha = 0.5) +  # Add points for individual poll data
...
By using package `usmap` [@citeusmap], @fig-statemap displays the predicted outcome for each state in the 2024 U.S. Presidential Election, with red representing states where Trump is expected to win and blue for those favoring Harris.
