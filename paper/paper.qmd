...
\mu_i &= \beta_0 + \beta_1 \cdot numeric_grade_i + \beta_2 \cdot methodology_i + \beta_3 \cdot duration_i + \beta_4 \cdot sample_size_i + \beta_5 \cdot transparency_score_i + \beta_6 \cdot state_i + \epsilon_i \
